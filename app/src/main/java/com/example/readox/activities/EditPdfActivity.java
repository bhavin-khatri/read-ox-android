...
import com.example.readox.databinding.ActivityEditPdfBinding;
...
public class EditPdfActivity extends AppCompatActivity {
    ...
    //get book id from intent started from adapterpdfadmin
    ...
    private void updatePdf() {
        Log.d(TAG, "updatePdf: Starting Updating EBook info to db...");
        progressDialog.setMessage("Updating EBook Info...");
        progressDialog.show();
        ...
        ref.child(bookId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Log.d(TAG, "onSuccess: EBook info Successfully updated ");
                        progressDialog.dismiss();
                        Toast.makeText(EditPdfActivity.this, "EBook Info Successfully Updated", Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG, "onFailure: Failed to update EBook info due to"+e.getMessage());
                        progressDialog.dismiss();
